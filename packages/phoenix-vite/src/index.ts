...
function routeTypesModule(
  ...
  return [
    "// This file is generated by @apizero/vite from Rust named routes. Do not edit.",
    ...imports,
...
function transformClientDirectives(source: string, id: string): { code: string; map: null } | null {
  ...
  code = `import { Island as ${identifier} } from "@apizero/react";\n${code}`;
...
function serverModule(
  ...
  const imports: string[] = [
    'import { registerIsland } from "@apizero/react";',
